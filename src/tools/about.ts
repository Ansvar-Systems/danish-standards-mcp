...
export function handleAbout() {
  ...
  lines.push('');
  lines.push(
    'This MCP server provides structured access to Danish cybersecurity and information security standards, ' +
    'including CFCS guidelines, Digitaliseringsstyrelsen guidance, Statens ISO 27001, D-maerket, Datatilsynet measures, and Sundhedsdatastyrelsen requirements.'
  );
  lines.push('');
